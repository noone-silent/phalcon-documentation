...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-cache]

The [Cache][phalcon-cache] component has been moved to the `Cache` namespace.
...
- The component has been refactored and the dependency to `PSR` has been removed. [more][phalcon-cache]
...
![](assets/images/status-no-changes-blue.svg) [![](assets/images/status-docs.svg)][phalcon-application-cli]

---

### Collection

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-support-collection]

The [Collection][phalcon-support-collection] component has been moved to the `Support` namespace. [more](#support)

---

### Config

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-config]

The [Config][phalcon-config] component has been moved to the `Config` namespace.
...
![](assets/images/status-no-changes-blue.svg) [![](assets/images/status-docs.svg)][phalcon-datamapper]

---

### Db

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-db-layer]
...
- Added bind type for `Column::TYPE_BINARY` to cater to `VARBINARY` and `BINARY` fields
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-support-debug]

The [Debug][phalcon-support-debug] component has been moved to the `Support` namespace. [more][support]

---

### Di

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-di]

The [Di][phalcon-di] component has been moved to the `Di` namespace.
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-dispatcher]
...
![](assets/images/status-no-changes-blue.svg) [![](assets/images/status-docs.svg)][phalcon-domain]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-html-escaper]

The [Escaper][phalcon-html-escaper] component has been moved to the `Html` namespace. [more](#html)

---

### Events

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-events]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-filter-filter]

The [Filter][phalcon-filter-filter] component has been moved to the `Filter` namespace.
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-flash]
...
The [Helper][phalcon-support-helper] component has been moved to the `Support` namespace. [more][support]

---

### Html

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-html]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-logger]

The [Logger][phalcon-logger] component has been moved to the `Logger` namespace.

#### `Phalcon\Logger\Logger`
- Moved `Phalcon\Logger` to `Phalcon\Logger\Logger`
- The component has been refactored and the dependency to `PSR` has been removed. [more][phalcon-logger]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-mvc]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-db-pagination]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-support-registry]

The [Registry][phalcon-support-registry] component has been moved to the `Support` namespace. [more](#support)

---

### Security

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-encryption-security]

The [Security][phalcon-encryption-security] component has been moved to the `Encryption` namespace. [more](#encryption)

---

### Session

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-session]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-storage]
...
- [Debug][phalcon-support-debug]
- [Helper][phalcon-support-helper]
- [Registry][phalcon-support-registry]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-tag]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-translate]
...
![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-mvc-url]

The [Url][phalcon-mvc-url] component has been moved to the `Mvc` namespace. [more](#mvc)

---

### Validation

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-filter-validation]

The [Validation][phalcon-filter-validation] component has been moved to the `Filter` namespace. [more](#filter)

---

### Version

![](assets/images/status-changes-required-red.svg) [![](assets/images/status-docs.svg)][phalcon-support-version]

The [Version][phalcon-support-version] component has been moved to the `Support` namespace. [more](#support)
